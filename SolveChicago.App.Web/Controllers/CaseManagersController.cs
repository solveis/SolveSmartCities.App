...
namespace SolveChicago.App.Web.Controllers
{
    public class CaseManagersController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,ProfilePicturePath,Phone,Address1,Address2,City,Province,Country,CreatedDate")] CaseManager caseManager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,ProfilePicturePath,Phone,Address1,Address2,City,Province,Country,CreatedDate")] CaseManager caseManager)
        {
            if (ModelState.IsValid)
            {
