...
namespace SolveChicago.App.Web.Controllers
{
    public class CorporationsController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Phone,Address1,Address2,City,Province,Country,CreatedDate")] Corporation corporation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Phone,Address1,Address2,City,Province,Country,CreatedDate")] Corporation corporation)
        {
            if (ModelState.IsValid)
            {
