...
{
    public class GovernmentProgramsController : BaseController
    {
        public GovernmentProgramsController(SolveChicagoEntities db) : base(db) { }
        public GovernmentProgramsController() : base() { }
